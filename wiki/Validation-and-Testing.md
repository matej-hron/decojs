...
- **Dive-plan runtime marker.** Verifies that both split dive-plan tables bind the shared runtime footnote to their Runtime heading with a superscript asterisk.
